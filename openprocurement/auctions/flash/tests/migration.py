...
from openprocurement.auctions.flash.migration import migrate_data, get_db_schema_version, set_db_schema_version, SCHEMA_VERSION
from openprocurement.auctions.flash.tests.base import test_auction_data, BaseWebTest
