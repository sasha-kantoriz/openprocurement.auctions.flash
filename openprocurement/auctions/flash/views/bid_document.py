...
class AuctionBidDocumentResource(object):
    ...
    def collection_post(self):
        ...
        if save_auction(self.request):
            LOGGER.info('Created auction bid document {}'.format(document.id),
    ...
    def put(self):
        ...
        self.request.validated['bid'].documents.append(document)
        if save_auction(self.request):
            LOGGER.info('Updated auction bid document {}'.format(self.request.context.id),
