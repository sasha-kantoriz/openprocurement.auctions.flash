...
class AuctionAwardComplaintDocumentResource(object):
    ...
    @json_view(permission='review_complaint', validators=(validate_file_upload,))
    def collection_post(self):
        ...
        if save_auction(self.request):
            LOGGER.info('Created auction award complaint document {}'.format(document.id),
    ...
    def put(self):
        ...
        self.request.validated['complaint'].documents.append(document)
        if save_auction(self.request):
            LOGGER.info('Updated auction award complaint document {}'.format(self.request.context.id),
